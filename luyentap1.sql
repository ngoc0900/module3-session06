...
DELIMITER $$
create trigger trigger_delete_Employees
after delete on employees
for each row
begin
	 insert into deleted_employees set 
     employee_id = old.employee_id,
     first_name = old.first_name,
     last_name = old.last_name,
     middle_name = old.middle_name,
     job_title = old.job_title,
     deparment_id = old.department_id,
     salary = old.salary ;
	
end
$$ DELIMITER ;
drop trigger trigger_delete_Employees;
delete from employees where employee_id = 291;
